...
import static demo.test.jeann.exercise.utilities.AppConstant.CITYWIDE_EMPTY_ERROR_MESSAGE;
import static demo.test.jeann.exercise.utilities.AppConstant.CITYWIDE_NULL_ERROR_MESSAGE;
import static demo.test.jeann.exercise.utilities.AppConstant.COUNTRYSIDE_EMPTY_ERROR_MESSAGE;
import static demo.test.jeann.exercise.utilities.AppConstant.COUNTRYSIDE_NULL_ERROR_MESSAGE;
import static demo.test.jeann.exercise.utilities.AppConstant.NUMBER_EMPTY_ERROR_MESSAGE;
import static demo.test.jeann.exercise.utilities.AppConstant.NUMBER_NULL_ERROR_MESSAGE;
