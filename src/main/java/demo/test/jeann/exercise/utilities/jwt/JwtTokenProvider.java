...
import static demo.test.jeann.exercise.utilities.AppConstant.EXPIRED_TIME_TOKEN_SESSION;
...
public class JwtTokenProvider {
  ...
  @Autowired private GlobalLogicRepository globalLogicRepository;
  ...
  public boolean validateToken(String token) {
    ...
    try {
      ...
      final User findTokenDB = globalLogicRepository.findUserByToken(token);
